...
export default function Home() {
  ...
  // Re-initialize Lucide icons on mobile and after any state change
  useEffect(() => {
    const initIcons = () => {
    ...
    // Re-create icons after delays to ensure DOM is ready
    const timer1 = setTimeout(initIcons, 100)
    const timer2 = setTimeout(initIcons, 500)
    const timer3 = setTimeout(initIcons, 1000)
    
    // Re-create icons on mobile specifically
    if (isMobile) {
      const timer4 = setTimeout(initIcons, 1500)
      const timer5 = setTimeout(initIcons, 2000)
      return () => {
        clearTimeout(timer1)
        clearTimeout(timer2)
        clearTimeout(timer3)
  ...
  // Re-initialize icons when scrolling stops (for lazy-loaded content)
  useEffect(() => {
...
{/* Services Overview */}
            ...
            <section className="px-6 md:px-10 lg:px-20 py-10">
              ...
              <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up animate-delay-400">
                  ...
                  >
                    <i data-lucide="phone" className="w-6 h-6" style={{ color: 'white', stroke: 'white' }}></i>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">{/* Column 1 - Some Tips & Tricks */}
                  <div>
                    ...
                    <ul className="space-y-3 text-base">
                      <li><Link className="text-subtext-light dark:text-subtext-dark hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/property-tips">Property Tips</Link></li>
                      <li><Link className="text-subtext-light dark:text-subtext-dark hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/legal-advice">Legal Advice</Link></li>
                      <li><Link className="text-subtext-light dark:text-subtext-dark hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/tax-saving-tips">Tax Saving Tips</Link></li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-3 text-base">
                      <li><Link className="text-subtext-light dark:text-subtext-dark hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="#faq">View FAQs</Link></li>
                    </ul>
                    
                    <ul className="space-y-3 text-base">
                      <li><Link className="text-subtext-light dark:text-subtext-dark hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/contact">Get In Touch</Link></li>
                    </ul>                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-3 text-base">
                      <li><Link className="text-subtext-light dark:text-subtext-dark hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/privacy-policy">Privacy Policy</Link></li>
                      <li><Link className="text-subtext-light dark:text-subtext-dark hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/refund-policy">Refund Policy</Link></li>
                      <li><Link className="text-subtext-light dark:text-subtext-dark hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/payment-policy">Payment Policy</Link></li>
                      <li><Link className="text-subtext-light dark:text-subtext-dark hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/cookie-policy">Cookie Policy</Link></li>
                      <li><Link className="text-subtext-light dark:text-subtext-dark hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/terms-conditions">Terms & Conditions</Link></li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <a 
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 text-base text-subtext-light dark:text-subtext-dark hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                      >
                    ...
                    <p className="mt-4 text-sm font-semibold text-blue-600">Trusted By 1 Lac + Happy Clients</p>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-3 text-base">
                      <li><Link className="text-subtext-light dark:text-subtext-dark hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/">Home</Link></li>
                      <li><Link className="text-subtext-light dark:text-subtext-dark hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/services">Deed And Documents</Link></li>
                      <li><Link className="text-subtext-light dark:text-subtext-dark hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/solutions/buyer">Custom Solutions</Link></li>
                      <li><Link className="text-subtext-light dark:text-subtext-dark hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/services">All Services</Link></li>
                      <li><Link className="text-subtext-light dark:text-subtext-dark hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/about">Company</Link></li>
                      <li><Link className="text-subtext-light dark:text-subtext-dark hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/contact">Contact Us Now</Link></li>
                    </ul>
                  </div>
                </div>
            ...
            >
              ...
              <div className="bg-blue-600 p-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-bold text-white">Doorstep Advice Service</h3>
                  </div>
                  <button
                    onClick={() => setShowDoorstepModal(false)}
              ...
              <div className="p-6">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 mb-6">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">One-time consultation fee</div>
                </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full bg-green-600 hover:bg-green-700 text-white px-6 py-4 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-3 shadow-lg hover:shadow-xl"
                >
        ...
        <div className="fixed bottom-6 right-6 z-40 group">
          <button
            ...
            className="w-14 h-14 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center hover:scale-110 active:scale-95"
          ...
          {/* Tooltip */}
          <div className="absolute bottom-16 right-0 bg-gray-900 text-white text-sm px-4 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none shadow-xl">
            Ask AI Assistant
