...
export default function PowerOfAttorneyPage() {
  ...
  const tabContent = {
    ...
    'when-to-use': 'Power of Attorney is essential when you\'re living abroad and need someone to handle property matters in India, when you\'re elderly or unwell and need assistance with legal affairs, for NRIs who want to buy, sell, or manage property remotely, when you\'re traveling for extended periods, or when you want someone to handle specific transactions like property registration, bank dealings, or court matters on your behalf. It\'s your solution for remote property management and legal representation.',
