...
export default function RentAgreementPage() {
  ...
  const documents = [
    ...
    },
    {
      ...
      description: 'Recent passport-size photographs of both landlord and tenant for document verification.'
    },
    {
      title: 'Bank Account Details',
      description: 'Bank account information for rent payment processing and security deposit transactions.'
    }
  ]
  ...
  const process = [
    {
      ...
      description: 'We analyze the rental property details, terms, and requirements for creating a comprehensive rent agreement.'
    },
    {
      step: 2,
      title: 'Legal Drafting',
      description: 'Our legal experts prepare a detailed Rent Agreement as per law, ensuring all clauses and terms are included.'
    },
    {
      step: 3,
      title: 'Terms Verification',
      description: 'We verify all rental terms, conditions, and ensure mutual agreement between landlord and tenant.'
    },
    {
      step: 4,
      title: 'Registration Process',
      description: 'Complete guidance for stamp duty payment and registration of the Rent Agreement as per local laws.'
    },
    {
      step: 5,
      title: 'Document Delivery',
      description: 'Final registered agreement delivered to both parties with all necessary legal compliance certificates.'
    }
  ]

  const tabContent = {
    'what-is': 'A Rent Agreement is a legal contract between a landlord (property owner) and tenant that defines the terms and conditions for renting a property. This document establishes the rights and obligations of both parties, including rent amount, security deposit, lease duration, maintenance responsibilities, and termination conditions. The agreement contains property details, rental terms, payment schedule, rules and regulations, and dispute resolution mechanisms. It serves as legal protection for both parties and provides a framework for the landlord-tenant relationship.',
    'when-to-use': 'A Rent Agreement is used whenever you are renting out or renting a property for residential or commercial purposes. It is essential for all rental transactions, whether short-term or long-term leases, furnished or unfurnished properties, and residential or commercial spaces. This agreement is mandatory for legal protection, tax compliance, police verification, and establishing clear terms. It is required for rent receipts, TDS compliance, security deposit protection, and resolving any future disputes between parties.',
    'legal-implications': 'A registered Rent Agreement provides legal protection to both landlord and tenant and is enforceable in courts. It establishes clear rights and obligations, protects against arbitrary rent increases or eviction, and provides legal recourse in case of disputes. The agreement must comply with local rent control laws, be stamped appropriately, and registered if required by state law. Once executed, it creates binding legal obligations, protects security deposits, ensures proper notice periods, and serves as evidence in legal proceedings.'
  }
            ...
            <div className="relative max-w-6xl mx-auto px-8 py-16 md:py-24">
              <div className="text-center">
                ...
                <p className="text-subtext-light dark:text-subtext-dark text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed mb-12 font-medium">
                  Professional rent agreement drafting and registration services with complete legal compliance and tenant protection.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                  ...
                  <div className="flex items-center justify-center gap-3 p-4 bg-white/80 dark:bg-slate-800/80 rounded-xl backdrop-blur-sm shadow-md">
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-sm text-subtext-light dark:text-subtext-dark">2-3 Business Days</div>
                    </div>
                  </div>
          ...
          <div className="max-w-6xl mx-auto space-y-16">
              ...
              <div className="relative">
                <div className="text-center mb-12">
                  ...
                  <p className="text-subtext-light dark:text-subtext-dark text-lg max-w-2xl mx-auto">
                    Our streamlined process ensures your rent agreement is completed efficiently and legally
                  </p>
                </div>
              ...
              <div className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-slate-800 dark:to-slate-700 p-8 border-b border-yellow-200/50 dark:border-slate-700">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-subtext-light dark:text-subtext-dark">Essential documents for your rent agreement process</p>
                  </div>
                </div>
              </div>
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-secondary rounded-3xl p-12 text-center">
              ...
              <div className="relative">
                ...
                <h3 className="text-white text-3xl md:text-4xl font-bold mb-4">Ready to Create Your Rent Agreement?</h3>
                <p className="text-white/90 text-xl mb-8 max-w-2xl mx-auto">
                  Protect your rental interests with professional legal documentation and complete compliance
                </p>
