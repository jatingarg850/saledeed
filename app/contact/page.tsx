          ...
          <div className="mt-16 bg-gradient-to-r from-primary to-yellow-800 dark:from-primary/80 dark:to-yellow-900 rounded-2xl p-8 md:p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                ...
                className="flex items-center justify-center rounded-full h-14 px-8 bg-gradient-to-r from-yellow-500 to-orange-500 text-white text-lg font-bold leading-normal tracking-wider transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl shadow-xl shadow-orange-500/40"
              >
              ...
              <a 
                href="https://api.whatsapp.com/send?phone=918800505050&text=Hello%2C%20I%20need%20assistance%20with%20property%20documentation"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center rounded-full h-14 px-8 bg-white/20 backdrop-blur-sm text-white text-lg font-bold leading-normal tracking-wider border-2 border-white/30 hover:bg-white/30 transition-all duration-300 transform hover:-translate-y-1"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2">
