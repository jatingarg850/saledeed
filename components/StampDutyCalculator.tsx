    ...
    <div className="bg-gradient-to-br from-yellow-50 via-white to-orange-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 rounded-2xl border-2 border-yellow-200/50 dark:border-slate-700 overflow-hidden shadow-2xl">
      ...
      <div className="p-8 md:p-10 space-y-6">
        ...
        <button
          ...
          className="w-full bg-transparent from-primary to-secondary hover:from-secondary hover:to-primary text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl text-lg flex items-center justify-center gap-2 border-2 border-blue-600"
          style={{ color: 'white' }}
        >
